...
* 锁膨胀 (锁升级)  
在 JDK 6 之后, JVM 对 synchronized 的锁机制做了优化, 从原来的无锁直接借助操作系统上锁的机制, 修改为锁缓慢升级的, 在运行中，根据线程对锁的竞争程度，逐渐升级 无锁 -> 偏向锁 -> 轻量级锁 -> 重量级锁 的过程。

## 6. synchronize 实现相关知识
...
* 6.1.2 instance data/ array data  
...
![Alt '32bitMarkWordLayout'](https://raw.githubusercontent.com/PictureRespository/Java/main/JUCV/32bitMarkWordLayout.png)


64 位 Mark Word 的布局:
![Alt '64bitMarkWordLayout'](https://raw.githubusercontent.com/PictureRespository/Java/main/JUCV/64bitMarkWordLayout.png)
...
上面就是 synchronized 关键字的简单介绍, 下面就是介绍 monitorenter he monitorexit 2 个字节码可以让 JVM 做了什么
