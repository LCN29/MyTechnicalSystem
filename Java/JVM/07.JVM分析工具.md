...
## 7.2 jinfo (Configuration Info for Java) - Java 配置信息工具
...
## 7.3 jmap (Memory Map for Java) - Java 内存映像工具
...
## 7.4 jhat (JVM Heap Analysis Tool) - 虚拟机堆转储快照分析工具
...
## 7.5 jstack (Stack Trace for Java) - Java 堆栈跟踪工具
